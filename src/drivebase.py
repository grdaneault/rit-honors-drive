#!/usr/bin/python
#
# drivebase.py is simply the main.py file from the Dr Edit sample
# application without the MainPage request handler and the WSGI
...
# Note: no commas, space at the end of string
...
class BaseDriveHandler(webapp.RequestHandler):
    ...
    def CreateOAuthFlow(self):
        ...
        flow.redirect_uri = "https://rithonorsdrive.appspot.com/" #self.request.url.split('?', 1)[0].rsplit('/', 1)[0]
        return flow
